...
class Ticket(db.Model):
    ...
    # Removed machine_id column as it doesn't exist in the database
...
def dashboard():
    ...
    return render_template('dashboard.html', klanten=customers, tickets=tickets, contracten=contracten, machines=machines)
...
def customer_dashboard():
    ...
    return render_template('customer_dashboard.html', tickets=tickets, contracten=contracten, machines=machines)
